...
| Keyboard remap (Karabiner/Kanata) | `macos/.config/karabiner/karabiner.json`, `macos/.config/kanata/*.kbd` | `README.md` for intended architecture |
